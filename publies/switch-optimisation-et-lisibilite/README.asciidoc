...
Les personnes qui développent ces moteurs JavaScript vont étudier le code des sites les plus visités, pour identifier des optimisations dnce type et d'autres types qu'il est possible d'ajouter dans les versions suivantes des navigateurs.
